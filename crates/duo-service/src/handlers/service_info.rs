...
/// Return GA4GH Service Info metadata for this DUO service.
...
pub async fn service_info(State(state): State<Arc<AppState>>) -> Json<ServiceInfo> {
    Json(ServiceInfo {
        ...
        name: "GA4GH DUO Service".to_string(),
        r#type: ServiceType {
            group: "org.ga4gh".to_string(),
            artifact: "duo".to_string(),
        ...
        description: Some(
            "Data Use Ontology term catalog and dataset-to-intended-use matching API".to_string(),
        ),
