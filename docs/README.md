...
| [idp-integration.md](idp-integration.md) | Keycloak, Entra ID, ELIXIR LS Login, Shibboleth OIDC |
...
| [governance.md](governance.md) | Bus factor, dual control, how to cut a signed release |
| [key-rotation.md](key-rotation.md) | RS256 overlap runbook |
| [ga4gh-compliance.md](ga4gh-compliance.md) | AAI / Passport / Service Info self-assessment |
| [SECURITY.md](../SECURITY.md) | Vulnerability reporting |
| [agreement-registry/](agreement-registry/README.md) | Optional policy/DUO compatibility layer (Phase 8) |
| [admin-ui/](admin-ui/overview.md) | Operations dashboard (Phase 9) |
